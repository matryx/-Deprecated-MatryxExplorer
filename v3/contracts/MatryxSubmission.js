...
module.exports = class MatryxSubmission extends Contract {
  ...
  async getData() {
    ...
    let { owner, tournament, round, timeSubmitted, timeUpdated, reward } = info
    let { title, descHash, fileHash, distribution, contributors, references } = details
  ...
  async getDistribution() {
    return await this.contract.getDistribution()
  }
  ...
  async getViewers() {
    return await this.contract.getViewers()
  }
